...
export default (nodefony) => {
   ...
   */
  const rstr_hmac_md5 = function (key, data) {
   ...
   */
  const rstr2any = function (input, encoding) {
   ...
   */
  const str2rstr_utf16le = function (input) {
    let output = "";
    for (let i = 0; i < input.length; i++) {
  ...
  const str2rstr_utf16be = function (input) {
    let output = "";
    for (let i = 0; i < input.length; i++) {
